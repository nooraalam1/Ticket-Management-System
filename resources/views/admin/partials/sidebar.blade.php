      ...
      <div class="sidebar-content">
          ...
          <div class="sidebar-user">
              <div class="card-body">
                  <div class="media">
                      <div class="mr-3">
                          <a href="#"><img src="{{ asset('logo.png') }}" width="38" height="38"
          ...
          <div class="card card-sidebar-mobile">
              <ul class="nav nav-sidebar" data-nav-type="accordion">
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Trains</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Route</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-plus22"></i>
                                  Create</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-pencil4"></i>
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Route Stops</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="  " class="nav-link active">Default layout</a></li>
                      </ul>
                  </li>
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Coaches</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-plus22"></i>
                                  Create</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i
                                      class="icon-pencil4"></i> Edit</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i
                                      class="icon-eye8"></i>View</a></li>
                      </ul>
                  </li>
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Seats</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-plus22"></i>
                                  Create</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Trips</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-plus22"></i>
                                  Create</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Fares</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="" class="nav-link active"><i class="icon-plus22"></i>
                                  Create</a></li>
                          <li class="nav-item"><a href="" class="nav-link active"><i
                  ...
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Bookings</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="  " class="nav-link active">Default layout</a></li>
                      </ul>
                  </li>
                  <li class="nav-item nav-item-submenu">
                      <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Booking Seats</span></a>
                      <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                          <li class="nav-item"><a href="  " class="nav-link active">Default layout</a></li>
                      </ul>
                  </li>
